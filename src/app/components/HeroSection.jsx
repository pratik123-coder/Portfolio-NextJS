      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div className="flex justify-start items-center">
            <Link href="https://res.cloudinary.com/dbzo04n4l/image/upload/f_auto,q_auto/zkxgp3i0obzz95aa1jy3" target="_blank" className="px-1 inline-block py-1 w-full sm:w-fit mt-3">
              <Button
            ...
            <div>
              <ul class="flex justify-center mt-5 space-x-5 ps-10">
                <li>
                  <a href="https://www.instagram.com/itspratikmohanty/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                ...
                <li>
                  <a href="https://github.com/pratik123-coder" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                    <svg class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fill-rule="evenodd"
                ...
                <li>
                  <a href="https://www.linkedin.com/in/pratikmohantycodes/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
